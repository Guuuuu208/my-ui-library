...
- [组件源码](../../../vendor/fancy/src/fancy/components/text/underline-goes-out-comes-in.tsx)
...
- hover：第 123 行。
- accessible-text：第 139 行。

## 完整本地依赖链

- [src/fancy/components/text/underline-goes-out-comes-in.tsx](../../../vendor/fancy/src/fancy/components/text/underline-goes-out-comes-in.tsx)
