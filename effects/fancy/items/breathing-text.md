...
- [组件源码](../../../vendor/fancy/src/fancy/components/text/breathing-text.tsx)
...
- variable-font：第 70 行。
- accessible-text：第 115 行。

## 完整本地依赖链

- [src/fancy/components/text/breathing-text.tsx](../../../vendor/fancy/src/fancy/components/text/breathing-text.tsx)
...
- [Breathing Text](../../../vendor/fancy/src/content/docs/components/text/breathing-text.mdx) / [原站](https://www.fancycomponents.dev/docs/components/text/breathing-text)
- [原始示例](../../../vendor/fancy/src/fancy/examples/text/breathing-text-demo.tsx)
