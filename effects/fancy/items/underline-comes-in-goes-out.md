...
- [组件源码](../../../vendor/fancy/src/fancy/components/text/underline-comes-in-goes-out.tsx)
- [许可证](../../../vendor/fancy/LICENSE)
- 上游版本：`f9f62c61207b2dd3210476dd98af3c9a5be24094`

## 源码结构

直接导入：`react`、`clsx`、`motion/react`。

静态特征（行号对应原文件）：

- hover：第 123 行。
- accessible-text：第 138 行。

## 完整本地依赖链

- [src/fancy/components/text/underline-comes-in-goes-out.tsx](../../../vendor/fancy/src/fancy/components/text/underline-comes-in-goes-out.tsx)

外部包：`clsx ^2.1.1`、`motion ^12.23.24`、`react ^19.2.1`。这不是建议升级版本；锁定版本见原始 package-lock.json。
