...
- [组件源码](../../../vendor/fancy/src/fancy/components/blocks/simple-carousel.tsx)
...
- scroll：第 7 行。
- frame-loop：第 5 行。
- accessible-text：第 265 行。

## 完整本地依赖链

- [src/fancy/components/blocks/simple-carousel.tsx](../../../vendor/fancy/src/fancy/components/blocks/simple-carousel.tsx)
