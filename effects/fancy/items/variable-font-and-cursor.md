...
- [组件源码](../../../vendor/fancy/src/fancy/components/text/variable-font-and-cursor.tsx)
...
- pointer：第 7 行。
- frame-loop：第 4 行。
- variable-font：第 140 行。

## 完整本地依赖链

- [src/fancy/components/text/variable-font-and-cursor.tsx](../../../vendor/fancy/src/fancy/components/text/variable-font-and-cursor.tsx)
...
- [Variable Font And Cursor](../../../vendor/fancy/src/content/docs/components/text/variable-font-and-cursor.mdx) / [原站](https://www.fancycomponents.dev/docs/components/text/variable-font-and-cursor)
- [原始示例](../../../vendor/fancy/src/fancy/examples/text/variable-font-and-cursor-demo.tsx)
